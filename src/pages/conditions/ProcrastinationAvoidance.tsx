...
import { ArrowLeft, Brain, Clock, Target, AlertTriangle, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-primary/5">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            <img 
              src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1200&h=400" 
              alt="Procrastination and Avoidance" 
          ...
          <Card className="p-8 text-center bg-primary text-primary-foreground">
            <h2 className="text-2xl font-bold mb-4">Ready to Overcome Procrastination?</h2>
            <p className="text-lg mb-6 opacity-90">
              Transform your productivity and achieve your goals with RECODE
            </p>
