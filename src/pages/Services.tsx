...
const Services = () => {
  ...
  // Ready to Commit
  {
    ...
    duration: "15 mins",
    price: "£29",
    bullets: ["15 minute check-in or emergency session", "Discuss new events and help break them down for analysis", "Refresh aspects of the course or exercises", "*Previous session required"],
  ...
  // Intensive Support
  {
    ...
    bullets: ["Structured plan", "Continuity", "Priority scheduling", "Pre-paid convenience"],
    ...
    originalPrice: "£676",
    savings: "SAVE £76",
    bullets: ["Intermediate course approach, ReCODE psychoanalysis and applied CBT theory, and DBT styled exercises", "Reports and home content issued with each session", "Free 15 minute drop in session included", "SAVE £76 on 4 session course compared to single sessions"],
