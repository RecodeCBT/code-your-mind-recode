        ...
        <div className="container mx-auto max-w-4xl relative z-10">
          <div className="text-center space-y-6">
            <div className="space-y-4">
              <p className="text-xl leading-relaxed text-foreground font-semibold mb-4">
                Your brain isn't broken —it's <em>coded</em>.
              </p>
              <p className="text-xl leading-relaxed text-foreground">
                At Recode CBT, we show people and organisations how to identify the hidden scripts that drive anxiety, stress, or low motivation, and how to reprogram them for growth.
              </p>
            <p className="text-sm md:text-lg leading-relaxed text-muted-foreground border-2 border-gradient-to-r from-blue-200 via-blue-300 to-blue-200 bg-gradient-to-r from-blue-50/30 via-white/50 to-blue-50/30 rounded-lg p-6 shadow-sm border-blue-200">
      ...
      <section className="py-8 px-4 bg-gradient-to-r from-secondary/5 via-orange-500/5 to-purple-600/5 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="text-center mb-8">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 text-center">Conditions We Address</h2>
      ...
      <section className="py-12 px-4 border-y-2 border-gradient-to-r from-orange-500/20 via-purple-600/20 to-blue-600/20 bg-gradient-to-r from-orange-500/10 via-purple-600/10 to-blue-600/10 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-3xl relative z-10">
          <div className="text-center">
            ...
            <div className="w-54 h-54 mx-auto mb-4 bg-gradient-to-br from-orange-50/90 to-purple-50/90 dark:from-orange-950/60 dark:to-purple-950/60 rounded-full p-4 backdrop-blur-md shadow-xl border-2 border-gradient-to-br from-orange-500/30 to-purple-600/30">
              <div className="w-full h-full bg-white dark:bg-gray-900 rounded-full p-3 flex items-center justify-center">
                <img src="/lovable-uploads/b976013c-0e4b-4791-b936-9d3f45544770.png" alt="ReCODE: ChatCBT Logo" className="w-full h-full object-cover rounded-full" />
              </div>
            </div>
      ...
      <section className="px-4 bg-muted/20 py-[12px]">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center text-sm text-muted-foreground">
            ...
            <Link to="/policies#top" className="text-xs text-muted-foreground hover:text-primary underline-offset-4 hover:underline block">
