...
export default function Footer() {
  return <footer className="bg-white px-4 text-center border-t border-gray-200 mt-12 py-2 my-px">
      <p className="text-sm text-gray-500 mb-0">© 2025 Recode CBT. All rights reserved.</p>
