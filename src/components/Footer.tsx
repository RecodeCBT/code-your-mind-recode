  ...
  return (
    <footer className="bg-white py-6 px-4 text-center border-t border-gray-200 mt-12">
      ...
      >
        ...
        >
          <path
            d="M7.5 2h9A5.5 5.5 0 0 1 22 7.5v9a5.5 5.5 0 0 1-5.5 5.5h-9A5.5 5.5 0 0 1 2 16.5v-9A5.5 5.5 0 0 1 7.5 2Zm9.75 3a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5ZM12 7.5A4.5 4.5 0 1 0 16.5 12 4.5 4.5 0 0 0 12 7.5Z"
          />
        </svg>
